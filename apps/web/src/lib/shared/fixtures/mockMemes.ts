...
export const MOCK_AUTHORS = {
  satoshi_claus: {
    ...
    walletAddress: '0x71C39B22C4e7a8920194B48924bcf34199018B29' as `0x${string}`,
  ...
  meme_archivist: {
    ...
    walletAddress: '0x3A291C4B52039184B48924bcf341990191C43A29' as `0x${string}`,
  ...
  fuji_builder: {
    ...
    walletAddress: '0x9E4431109aBC81920194B48924bcf34199014311' as `0x${string}`,
  ...
  anon_lurker: {
    ...
    walletAddress: '0x12F39B22C4e7a8920194B48924bcf341990167A0' as `0x${string}`,
